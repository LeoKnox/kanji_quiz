...
function MyHome() {
    ...
    return (testGame ? <>{ testGame }</> :
        ...
        <button onClick={() => setCurrComponent(<QuizKanji  currComponent={currUser.setCurrComponent(<NewKanji />)} practiceKanji={currUser.practiceKanji} />)} value="QuizKanji">Quiz</button>
        {currComponent}
